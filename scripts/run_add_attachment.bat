@echo off
echo ===============================================
echo =  AJOUT DE LA COLONNE ATTACHMENT MANQUANTE  =
echo ===============================================
echo.
echo Ce script va ajouter la colonne attachment manquante
...
echo.
echo [2/3] Ajout de la colonne attachment...
python scripts\add_attachment_field.py
if %errorlevel% neq 0 (
    echo ERREUR: Impossible d'ajouter la colonne attachment.
    goto :end
)
