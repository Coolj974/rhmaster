@echo off
echo ===============================================
echo =  AJOUT DE LA COLONNE UPDATED_AT MANQUANTE  =
echo ===============================================
echo.
echo Ce script va ajouter la colonne updated_at manquante
echo à la table LeaveRequest qui cause l'erreur actuelle.
echo.
...
echo.
echo [2/3] Ajout de la colonne updated_at...
python scripts\add_updated_at_field.py
if %errorlevel% neq 0 (
    echo ERREUR: Impossible d'ajouter la colonne updated_at.
    goto :end
)
